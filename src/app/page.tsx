        ...
        <div id={isClone ? undefined : "about"} className="container mx-auto px-4 md:px-0 min-h-dvh flex flex-col justify-center relative">
          <div className="about max-w-4xl text-left pt-20">
            ...
            <p className="font-syne text-foreground/80 text-lg md:text-[24px] leading-relaxed max-w-3xl">
              I'm a versatile Software Engineer with extensive experience building production-ready decentralized applications (dApps), high-performance backends, and immersive 3D interfaces. Expert in the **Monad ecosystem**, **Farcaster Mini-Apps**, and **modern Full Stack frameworks**. Proven track record of delivering end-to-end solutions, from signature-verified smart contracts to complex state-managed frontends.
            </p>
          </div>
